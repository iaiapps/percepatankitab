    ...
    <div class="card">
        <div class="card-body p-md-4 px-3">
            <form method="POST" action="{{ route('course.store') }}">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label text-md-end">Nama Kelas</label>
                ...
                <div class="mb-3">
                    <label for="youtube_url" class="form-label text-md-end">youtube_url</label>
                ...
                <div class="my-3">
                    <button type="submit" class="btn btn-primary w-100"> Tambah Kelas Baru </button>
                </div>
            </form>
        </div>
    </div>
