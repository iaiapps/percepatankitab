                    ...
                    @foreach ($payments as $payment)
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                <form class="d-block" onsubmit="return confirm('Apakah anda yakin untuk mengubah data?');"
                            ...
                            <td>
                                <form class="d-block" onsubmit="return confirm('Apakah anda yakin untuk menghapus data ?');"
